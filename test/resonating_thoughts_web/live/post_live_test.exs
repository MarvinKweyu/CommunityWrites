defmodule ResonatingThoughtsWeb.PostLiveTest do
  use ResonatingThoughtsWeb.ConnCase

  import Phoenix.LiveViewTest
  import ResonatingThoughts.BlogFixtures

  @create_attrs %{content: "some content", published: true, title: "some title"}
  @update_attrs %{content: "some updated content", published: false, title: "some updated title"}
  @invalid_attrs %{content: nil, published: false, title: nil}
