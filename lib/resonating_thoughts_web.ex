defmodule ResonatingThoughtsWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: ResonatingThoughtsWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/resonating_thoughts_web/templates",
        namespace: ResonatingThoughtsWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {ResonatingThoughtsWeb.LayoutView, "live.html"}
  ...
  defp view_helpers do
    quote do
      ...
      import ResonatingThoughtsWeb.LiveHelpers
